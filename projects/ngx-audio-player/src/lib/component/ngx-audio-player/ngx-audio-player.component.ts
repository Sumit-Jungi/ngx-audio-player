...
import { Component, OnInit, Input, ViewChild, Output, ElementRef, OnChanges, SimpleChanges, HostListener } from '@angular/core';
...
export class AudioPlayerComponent implements OnInit, OnChanges {
    ...
    ngOnInit() {
        ...
        if(this.innerWidth > 320 && this.innerWidth < 769){
            this.screenType = "mobile";
        }else{
            this.screenType = "desktop";
        }
        this.player.nativeElement.volume = this.value;
    ...
    ngOnChanges(changes: SimpleChanges) {
        if (changes.hasOwnProperty('displayArtist') || changes.hasOwnProperty('displayDuration') || changes.hasOwnProperty('displayId')) {
